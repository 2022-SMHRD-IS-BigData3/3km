		...
		<div class="add">
			<div>
				<div class="add1">
					...
					<div class="doginfo">
						<textarea name="강아지나이" id="dogname" cols="5" rows="1"
							placeholder="이름"></textarea>
					</div>
					<div class="doginfo">
						<textarea name="강아지나이" id="dogage" cols="5" rows="1"
							placeholder="나이"></textarea>
